...
TEST(getNeighboursNewton, ThreeDimTest)
{
    ...
    */
    ...
    EXPECT_TRUE(result.at(0) == 1 && result.at(1) == 3 && result.at(2) == 4 && result.at(3) == 12 && result.at(4) == 13
                && result.at(5) == 15 && result.at(6) == 16);
    ...
    EXPECT_TRUE(result.at(0) == 5 && result.at(1) == 6 && result.at(2) == 7 && result.at(3) == 8
                && result.at(4) == 16 && result.at(5) == 12 && result.at(6) == 13 && result.at(7) == 14 
                && result.at(8) == 15 && result.at(9) == 17 && result.at(10) == 18 && result.at(11) == 19
                && result.at(12) == 20);
    ...
    EXPECT_TRUE(result.size() == 13);
    EXPECT_TRUE(result.at(0) == 8 && result.at(1) == 9 && result.at(2) == 10 && result.at(3) == 11
                && result.at(4) == 19 && result.at(5) == 15 && result.at(6) == 16 && result.at(7) == 17 
                && result.at(8) == 18 && result.at(9) == 20 && result.at(10) == 21 && result.at(11) == 22
                && result.at(12) == 23);
