...
const dvector_t::X_type &dvector_t::X() const {
    return this->X_.get();
}

dvector_t::X_type &dvector_t::X() {
    return this->X_.get();
}

void dvector_t::X(const X_type &x) {
    this->X_.set(x);
}

const dvector_t::Y_type &dvector_t::Y() const {
    return this->Y_.get();
}

dvector_t::Y_type &dvector_t::Y() {
    return this->Y_.get();
}
...
logLevel_t(const logLevel_t &x,
           ::xml_schema::flags f,
           ::xml_schema::container *c)
        : ::xsd::cxx::tree::fundamental_base<::xml_schema::non_negative_integer, char, ::xml_schema::simple_type>(x, f,
                                                                                                                  c) {
}
...
logLevel_t(const ::xercesc::DOMElement &e,
           ::xml_schema::flags f,
           ::xml_schema::container *c)
        : ::xsd::cxx::tree::fundamental_base<::xml_schema::non_negative_integer, char, ::xml_schema::simple_type>(e, f,
                                                                                                                  c) {
}
...
logLevel_t(const ::xercesc::DOMAttr &a,
           ::xml_schema::flags f,
           ::xml_schema::container *c)
        : ::xsd::cxx::tree::fundamental_base<::xml_schema::non_negative_integer, char, ::xml_schema::simple_type>(a, f,
                                                                                                                  c) {
}
...
logLevel_t(const ::std::string &s,
           ...
           ::xml_schema::flags f,
           ::xml_schema::container *c)
        : ::xsd::cxx::tree::fundamental_base<::xml_schema::non_negative_integer, char, ::xml_schema::simple_type>(s, e,
                                                                                                                  f,
                                                                                                                  c) {
}
...
operator<<(::xercesc::DOMElement &e, const logLevel_t &i) {
    e
            << static_cast< const ::xsd::cxx::tree::fundamental_base<::xml_schema::non_negative_integer, char, ::xml_schema::simple_type> & > (i);
}
...
operator<<(::xercesc::DOMElement &e, const posTime_t &i) {
    e
            << static_cast< const ::xsd::cxx::tree::fundamental_base<::xml_schema::double_, char, ::xml_schema::simple_type, ::xsd::cxx::tree::schema_type::double_> & > (i);
}
