...
class gridDimType_pskel: public ::xml_schema::complex_content
{
  ...
  //
  void
  dimx_parser (::xml_schema::integer_pskel&);

  void
  dimy_parser (::xml_schema::integer_pskel&);

  void
  dimz_parser (::xml_schema::integer_pskel&);
...
class configuration_pskel: public ::xml_schema::complex_content
{
  ...
  //
  void
  fps_parser (::xml_schema::integer_pskel&);

  void
  video_length_parser (::xml_schema::integer_pskel&);

  void
  delta_t_parser (::xml_schema::decimal_pskel&);

  void
  end_time_parser (::xml_schema::decimal_pskel&);
...
class cuboid_pskel: public ::xml_schema::complex_content
{
  ...
  //
  void
  position_parser (::positionType_pskel&);

  void
  grid_dim_parser (::gridDimType_pskel&);

  void
  grid_spacing_parser (::xml_schema::decimal_pskel&);

  void
  temperature_parser (::xml_schema::decimal_pskel&);

  void
  mass_parser (::xml_schema::decimal_pskel&);

  void
  velocity_parser (::velocityType_pskel&);
