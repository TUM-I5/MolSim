...
Particle::Particle(int type_arg) {
  type = type_arg;
  if (verbose_particle) std::cout << "Particle generated!" << std::endl;
  f_1 = {0., 0., 0.};
  f_2 = {0., 0., 0.};
}
...
Particle::Particle(const Particle &other) {
  ...
  f_1 = other.getF();
  f_2 = other.getOldF();
  if (verbose_particle) std::cout << "Particle generated by copy!" << std::endl;
}
...
Particle::~Particle() {
  if (verbose_particle) std::cout << "Particle destructed!" << std::endl;
}
