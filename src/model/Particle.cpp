...
Particle::Particle(std::array<double, 3> x_arg, std::array<double, 3> v_arg, std::array<double, 3> f_arg, std::array<double, 3> old_f_arg,
                   double m_arg, double epsilon_arg, double sigma_arg, int type_arg) : x(x_arg), v(v_arg), f(f_arg), old_f(old_f_arg), m(m_arg), epsilon(epsilon_arg), sigma(sigma_arg), type(type_arg)
{
    cell_idx = 0;
    invalid = false;
    halo = false;
