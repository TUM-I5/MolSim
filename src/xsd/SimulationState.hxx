...
/**
 * @file
 * @brief Generated from SimulationState.xsd.
 */

#ifndef CXX_HOME_USER_DOCUMENTS_PROGRAMMING_PSEMOL_DYN_GROUP_G_SRC_XSD_SIMULATION_STATE_HXX
#define CXX_HOME_USER_DOCUMENTS_PROGRAMMING_PSEMOL_DYN_GROUP_G_SRC_XSD_SIMULATION_STATE_HXX
...
/**
 * @brief Class corresponding to the %simulation_state_t schema type.
 *
 * @nosubgrouping
 */
class simulation_state_t: public ::xml_schema::type
{
  public:
  /**
   * @name particle
...
/**
 * @brief Class corresponding to the %f schema type.
 *
 * @nosubgrouping
 */
class f: public ::xml_schema::type
{
  public:
  /**
   * @name x
...
/**
 * @brief Class corresponding to the %old_f schema type.
 *
 * @nosubgrouping
 */
class old_f: public ::xml_schema::type
{
  public:
  /**
   * @name x
...
/**
 * @name Parsing functions for the %simulation_state document root.
 */
//@{
...
simulation_state (const ::std::string& uri,
                  ::xml_schema::flags f = 0,
 ...
 */
::std::unique_ptr< ::simulation_state_t >
simulation_state (::xercesc::InputSource& is,
                  ::xml_schema::flags f = 0,
                  const ::xml_schema::properties& p = ::xml_schema::properties ());
 ...
 */
::std::unique_ptr< ::simulation_state_t >
simulation_state (const ::xercesc::DOMDocument& d,
                  ::xml_schema::flags f = 0,
                  const ::xml_schema::properties& p = ::xml_schema::properties ());
...
void
operator<< (::xercesc::DOMElement&, const simulation_state_t&);

/**
 * @name Serialization functions for the %simulation_state document root.
 */
//@{
 ...
 */
void
simulation_state (::std::ostream& os,
                  const ::simulation_state_t& x, 
 ...
 */
void
simulation_state (::xercesc::XMLFormatTarget& ft,
                  const ::simulation_state_t& x, 
                  const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
                  const ::std::string& e = "UTF-8",
                  ::xml_schema::flags f = 0);
...
simulation_state (const ::simulation_state_t& x, 
                  const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
                  ::xml_schema::flags f = 0);
...
void
operator<< (::xercesc::DOMElement&, const f&);

void
operator<< (::xercesc::DOMElement&, const old_f&);
...
#endif // CXX_HOME_USER_DOCUMENTS_PROGRAMMING_PSEMOL_DYN_GROUP_G_SRC_XSD_SIMULATION_STATE_HXX
