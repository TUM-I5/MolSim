...
Particle::Particle(const Particle &other) : 
  f_1_inplace(other.getF()) , 
  f_2_inplace(other.getOldF()),
  f_1(f_1_inplace),
  f_2(f_2_inplace) {
  x = other.x;
  v = other.v;
...
bool Particle::isSecondOld() const{
  return secondIsOld;
}
...
std::array<double,3>& Particle::getF1_ref(){
  return f_1;
}

std::array<double,3>& Particle::getF2_ref(){
  return f_2;
}
...
void Particle::setSecondOld(bool is_second_is_old){
  secondIsOld = is_second_is_old;
}
